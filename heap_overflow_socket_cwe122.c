...
gcc -g heap_overflow_socket_cwe122.c -o heap_overflow_socket_cwe122
./heap_overflow_socket_cwe122 server


another terminal for the client:
./heap_overflow_socket_cwe122

On MacOS I recommend: 
clang -fsanitize=address -g heap_overflow_socket_cwe122.c -o heap_overflow_socket_cwe122
./heap_overflow_socket_cwe122 server
